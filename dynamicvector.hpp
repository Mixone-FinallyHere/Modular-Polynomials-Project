...
// Constructors
template <typename T>
DynamicVector<T>::DynamicVector(const T& element, unsigned int dim): Vector<T>(element, dim) {}

template <typename T>
DynamicVector<T>::DynamicVector(const T* elemArray, unsigned int dim): Vector<T>(elemArray, dim) {}
...
template <typename T>
DynamicVector<T>::DynamicVector(DynamicVector<T>&& vect): Vector<T>(std::forward<DynamicVector<T>>(vect)) {}

template <typename T>
DynamicVector<T>::DynamicVector(const Vector<T>& vect): Vector<T>(vect) {}
